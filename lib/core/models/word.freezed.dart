...
class _$WordImpl implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, word: $word, userID: $userID, createdAt: $createdAt)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, word, userID, createdAt);
...
abstract class _Word implements Word {
  const factory _Word(
      ...
      @JsonKey(name: 'created_at') final DateTime? createdAt}) = _$WordImpl;
